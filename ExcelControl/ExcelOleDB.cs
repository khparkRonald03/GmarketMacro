...
namespace ExcelControl
{
    public class ExcelOleDB
    {
        ...
        /// </param>
        private bool SaveExcel(string FileName, DataSet DS, bool ExistDel, bool OldExcel)
        {
            bool result = true;
        ...
        /// </param>
        public DataSet OpenExcelDB(string ExcelFile)
        {
        ...
        ///    저장할 대상 DataSet 입니다.
        /// </param>
        public bool SaveExcelDB(string ExcelFile, DataSet DS)
        {
